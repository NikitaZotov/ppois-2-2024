...
from model.InvestmentPortfolio import InvestmentPortfolio
...
class BankAccount:
    ...
    def deposit(self, money_amount: float = 0.1) -> None:
        ...
        self.__transactions_history.append(Transaction(money_amount, 'Банковский счет - внесение средств', True))
    ...
    def withdrawal(self, money_amount: float = 0.1) -> None:
        ...
        if current_balance < money_amount:
            self.__transactions_history.append(Transaction(money_amount, 'Банковский счет - снятие средств', False))
            return
        current_balance -= money_amount
        self.__transactions_history.append(Transaction(money_amount, 'Банковский счет - снятие средств', True))
        self.__budget.set_money_amount(current_balance)
    ...
    def form_new_budget(self, withdrawing_money: bool = True) -> None:
