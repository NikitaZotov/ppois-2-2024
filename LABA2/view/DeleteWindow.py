...
class DeleteWindow(tk.Toplevel):
    ...
    def init_widgets(self):
        ...
        ttk.Button(self, text="Delete", command=self.delete_athlete).pack(pady=10)
    ...
    def delete_athlete(self):
        ...
        if amount_of_deleted_elements > 0:
            ...
            messagebox.showinfo("Delete athlete", "No athletes found for the given criteria")
