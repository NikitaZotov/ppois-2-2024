...
class RecordsScorePerMoveWindow:
    def __init__(self):
        pygame.init()
        ...
        self.records_headers: list = ["Place", "Name", "Score", "Moves"]
        self.records: list = self.json_manager.get_records_by_score_per_move_from_json()[:10]
